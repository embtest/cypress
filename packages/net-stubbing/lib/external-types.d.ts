...
declare namespace CyHttpMessages {
  ...
  interface IncomingHttpRequest extends IncomingRequest {
    /**
 ...
 */
type HttpRequestInterceptor = (req: CyHttpMessages.IncomingHttpRequest) => void | Promise<void>
 ...
 * handler synchronously.
 */
type HttpResponseInterceptor = (res: CyHttpMessages.IncomingHttpResponse) => void | Promise<void>

/**
 * Matches a single number or any of an array of acceptable numbers.
 */
type NumberMatcher = number | number[]
...
interface RouteMap { [key: string]: Route }
...
type RouteHandler = string | StaticResponse | RouteHandlerController | object

/**
 * Describes a response that will be sent back to the browser to fulfill the request.
 */
type StaticResponse = GenericStaticResponse<string, string | object> & {
  /**
